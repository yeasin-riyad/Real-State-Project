	...
	<form noValidate="" action="" className="container flex flex-col mx-auto space-y-12">
		<fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-50">
			<div className="space-y-2 col-span-full lg:col-span-1">
				...
				<p className="text-xs">Please Provide Your Personal Information which mention in the form.</p>
			</div>
		...
		<fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-50">
			<div className="space-y-2 col-span-full lg:col-span-1">
				...
				<p className="text-xs">Make Your Profile.</p>
			</div>
			<div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
				<div className="col-span-full sm:col-span-3">
				...
				<div className="col-span-full">
					...
					<div className="flex items-center space-x-2">
                        ...
                        <button type="button" className="px-4 py-2 border rounded-md dark:border-gray-800">Submit</button>
					</div>
				</div>
			</div>
		</fieldset>
