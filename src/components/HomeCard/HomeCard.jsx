...
const HomeCard = ({apartmentData}) => {
    const {id,estate_title,segment_name,status,price,image,button,location,area,bedrooms,bathrooms}=apartmentData;
  return (
    <div
    data-aos="zoom-in"
        ...
        <div className="card  bg-base-100 shadow-xl">
              ...
              <div className="card-body">
                ...
                <div className="card-actions justify-end mt-3">
                  <Link to={`/apartment/${id}`}><button className="btn btn-primary text-xl">{button}</button></Link>
                </div>
              </div>
            </div>
    </div>
